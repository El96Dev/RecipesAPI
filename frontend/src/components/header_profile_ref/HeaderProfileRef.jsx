...
export default function HeaderProfileRef() {
    return (
        <div className="login__wrapper">
            <svg className="login__svg" fill="#FFFFFF" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
            ...
            <NavLink>
                <div className="login__ref">Войти</div>
            </NavLink>
        </div>
    )
} 